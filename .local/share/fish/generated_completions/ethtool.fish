...
complete -c ethtool -l debug --description 'Turns on debugging messages.  Argument is interpreted as a mask: .'
complete -c ethtool -l json --description 'Output results in JavaScript Object Notation (JSON).'
...
complete -c ethtool -l get-tunable --description 'Get the tunable parameters. RS 4.'
complete -c ethtool -l set-tunable --description 'Set driver\'s tunable parameters. RS 4.'
...
complete -c ethtool -l cable-test --description 'Perform a cable test and report the results.'
complete -c ethtool -l cable-test-tdr --description 'Perform a cable test and report the raw Time Domain Reflectometer data.'
complete -c ethtool -l monitor --description 'Listens to netlink notification and displays them. RS 4.'
