...
complete -c pg_restore -s j --description 'Run the most time-consuming steps of pg_restore \\(em those that load data, cr…'
...
complete -c pg_restore -l no-comments --description 'Do not output commands to restore comments, even if the archive contains them.'
...
complete -c pg_restore -l no-acl --description 'is specified.'
